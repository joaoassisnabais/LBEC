...
def ideal_consumption(temp_min, temp_max, not_at_home, current_temp, external_temp):
    ...
    elif temp_min > current_temp: 
        return get_time_on(current_temp, external_temp, temp_min) * 2.5
    elif temp_max < current_temp: 
        return get_time_on(current_temp, external_temp, temp_max) * 2.5
    else: 
        return 0.270
